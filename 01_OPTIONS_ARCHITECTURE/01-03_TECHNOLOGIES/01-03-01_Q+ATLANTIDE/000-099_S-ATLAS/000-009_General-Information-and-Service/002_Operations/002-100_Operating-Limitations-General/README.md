# 002-100 — Operating Limitations — General
...
This node is the worked example for the item / subject naming pattern used across the
`000-009` master range (see the master-range `README.md`, §5). Items are markdown files
named `<node>-<item>-<Controlled-Title>.md`.
