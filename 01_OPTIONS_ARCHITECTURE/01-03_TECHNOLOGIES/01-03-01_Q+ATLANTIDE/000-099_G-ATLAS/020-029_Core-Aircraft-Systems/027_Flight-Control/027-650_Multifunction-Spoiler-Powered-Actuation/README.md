# 027-650 ⚡ — Multifunction-Spoiler Powered Actuation

**Node:** `027-650` ⇄ ATA **27-65** (conventional: Multifunction-spoiler hydraulic actuation)[^c-27hyd]
**Chapter:** `027_Flight-Control` · **Layer:** STD
**Owner:** Q-AIR · **Divergence node (⚡):** hydraulic actuator → agnostic powered actuation · **Green overlay:** Q-GREENTECH
