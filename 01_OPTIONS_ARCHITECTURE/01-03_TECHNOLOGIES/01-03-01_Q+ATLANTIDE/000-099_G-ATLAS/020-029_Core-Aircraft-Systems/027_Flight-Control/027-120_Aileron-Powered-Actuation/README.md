# 027-120 ⚡ — Aileron Powered Actuation

**Node:** `027-120` ⇄ ATA **27-12** (conventional: Aileron hydraulic actuation)[^c-27hyd]
**Chapter:** `027_Flight-Control` · **Layer:** STD
**Owner:** Q-AIR · **Divergence node (⚡):** hydraulic PCU → agnostic powered actuation · **Green overlay:** Q-GREENTECH
