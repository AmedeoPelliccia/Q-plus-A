...
- `053-800-010` - Forward Pressure Bulkhead (5 items)
- `053-800-020` - Rear Pressure Bulkhead (5 items)
- `053-800-030` - Forward Fuselage Landing Gear Fittings (4 items)
- `053-800-040` - Passenger and Service Door Frame Fittings and Plates (5 items)
- `053-800-050` - Cargo and Baggage Door Frame Fittings and Plates (4 items)
- `053-800-060` - Fuselage Plug Frame Fittings (3 items)
